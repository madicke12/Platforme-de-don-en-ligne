  ...
  <main className="flex">
    <aside className=" w-1/6 bg-red-200 ">
      ...
      <Link  className={`no-underline text-gray-800 p-2 font-bold hover:bg-red-300 mb-0 `} to={"."}>Mon profil</Link>
        <Link  className={`no-underline text-gray-800 p-2 font-bold hover:bg-red-300 mb-0 `} to={'historique'}>historique des dons</Link>
      </ul>
    </aside>
...
export default DonateurProfilePage